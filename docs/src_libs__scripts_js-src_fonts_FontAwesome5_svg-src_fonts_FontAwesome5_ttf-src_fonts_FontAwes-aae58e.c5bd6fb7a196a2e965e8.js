...
// }
var declOfNum = function declOfNum(number, words) {
...
var Diagram = /*#__PURE__*/function () {
  function Diagram(diagram) {
    ...
    _defineProperty(this, "currentKey", 'Удовлетворительно');

    _defineProperty(this, "bulletList", void 0);
    ...
    var _iterator = _createForOfIteratorHelper(this.bulletList.children),
        _step;
    ...
    var title = this.makeTitle(this.currentKey, this.chart);
  ...
  _createClass(Diagram, [{
    key: "makeTitle",
    value: function makeTitle(key) {
      var element = Array.from(this.chart.children).find(function (el) {
        return el.dataset.value === key;
      });
      ...
      title.className = 'diagram__title';
      var subtitle = declOfNum(count, ['голос', 'голоса', 'голосов']);
      title.innerHTML = "<span class='widget'>".concat(count, "</span><span class='label'>").concat(subtitle, "</span>");

      var _iterator2 = _createForOfIteratorHelper(title.children),
          _step2;
    ...
    key: "toggleClasses",
    value: function toggleClasses(e) {
      e.target.classList.toggle('bullet-list__span_hover');
    ...
    value: function changeTitle(e) {
      ...
      var count = +((_this$segment = this.segment) === null || _this$segment === void 0 ? void 0 : _this$segment.dataset.count);
      var that = this;
      var title = this.circle.querySelector('.diagram__title');
    ...
    value: function handleHover(e) {
      ...
      this.segment = Array.from(this.chart.children).find(function (el) {
        return el.dataset.value === _this.dataValue;
      });
    ...
    value: function handleClick(e) {
      ...
      if (!e.target.classList.contains('bullet-list__span')) return;
      var title = this.circle.querySelector('.diagram__title');
      var count = +((_this$segment2 = this.segment) === null || _this$segment2 === void 0 ? void 0 : _this$segment2.dataset.count);
      if (!count) return;
      var that = this;
      title.replaceWith(that.makeTitle(that.dataValue, that.chart));
...
var _iterator3 = _createForOfIteratorHelper(diagrams),
    _step3;

try {
  for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
    var diagram = _step3.value;
    new Diagram(diagram);
  }
} catch (err) {
  _iterator3.e(err);
...
/* harmony import */ var _blocks_diagram_diagram_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../blocks/diagram/diagram.js */ "./src/blocks/diagram/diagram.js");
/* harmony import */ var _blocks_diagram_diagram_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_blocks_diagram_diagram_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _blocks_expandable_checkbox_expandable_checkbox_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../blocks/expandable-checkbox/expandable-checkbox.js */ "./src/blocks/expandable-checkbox/expandable-checkbox.js");
/* harmony import */ var _blocks_expandable_checkbox_expandable_checkbox_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_blocks_expandable_checkbox_expandable_checkbox_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _blocks_expandable_list_expandable_list_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../blocks/expandable-list/expandable-list.js */ "./src/blocks/expandable-list/expandable-list.js");
/* harmony import */ var _blocks_expandable_list_expandable_list_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_blocks_expandable_list_expandable_list_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _blocks_filter_date_dropdown_filter_date_dropdown_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../blocks/filter-date-dropdown/filter-date-dropdown.js */ "./src/blocks/filter-date-dropdown/filter-date-dropdown.js");
/* harmony import */ var _blocks_header_header_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../blocks/header/header.js */ "./src/blocks/header/header.js");
/* harmony import */ var _blocks_header_header_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_blocks_header_header_js__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _blocks_iqdropdown_iqdropdown_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../blocks/iqdropdown/iqdropdown.js */ "./src/blocks/iqdropdown/iqdropdown.js");
...
/* harmony import */ var _blocks_like_button_like_button_js__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_blocks_like_button_like_button_js__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _blocks_masked_text_field_masked_text_field_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../blocks/masked-text-field/masked-text-field.js */ "./src/blocks/masked-text-field/masked-text-field.js");
/* harmony import */ var _blocks_navigation_navigation_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../blocks/navigation/navigation.js */ "./src/blocks/navigation/navigation.js");
/* harmony import */ var _blocks_navigation_navigation_js__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_blocks_navigation_navigation_js__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _blocks_pagination_pagination_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../blocks/pagination/pagination.js */ "./src/blocks/pagination/pagination.js");
/* harmony import */ var _blocks_pagination_pagination_js__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_blocks_pagination_pagination_js__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _blocks_rate_button_rate_button_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../blocks/rate-button/rate-button.js */ "./src/blocks/rate-button/rate-button.js");
/* harmony import */ var _blocks_rate_button_rate_button_js__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_blocks_rate_button_rate_button_js__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _blocks_sidebar_sidebar_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../blocks/sidebar/sidebar.js */ "./src/blocks/sidebar/sidebar.js");
/* harmony import */ var _blocks_sidebar_sidebar_js__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_blocks_sidebar_sidebar_js__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _blocks_slider_slider_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../blocks/slider/slider.js */ "./src/blocks/slider/slider.js");
/* harmony import */ var _blocks_subscription_text_field_subscription_text_field_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../blocks/subscription-text-field/subscription-text-field.js */ "./src/blocks/subscription-text-field/subscription-text-field.js");
/* harmony import */ var _blocks_subscription_text_field_subscription_text_field_js__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_blocks_subscription_text_field_subscription_text_field_js__WEBPACK_IMPORTED_MODULE_16__);
...
//# sourceMappingURL=src_libs__scripts_js-src_fonts_FontAwesome5_svg-src_fonts_FontAwesome5_ttf-src_fonts_FontAwes-aae58e.c5bd6fb7a196a2e965e8.js.map