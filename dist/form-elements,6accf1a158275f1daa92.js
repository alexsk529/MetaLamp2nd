...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).ready(function () {
  var counter = 0;
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.iqdropdown-menu').append("<div class='iqdropdown-button-round-container'><button-round class='iqdropdown-confirm-button-round label label_color_purple'>Применить</button-round></div>"); //iqdropdown initialization

  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.iqdropdown').iqDropdown({
    onChange: function onChange(id, count, totalItems) {
      var guests;
      var infants; //reset button-round

      counter = counter + 1;

      if (totalItems != 0 && counter == 1) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.iqdropdown-button-round-container').prepend("<button-round class='iqdropdown-clean iqdropdown-confirm-button-round label label_color_purple'>Очистить</button-round>");
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.iqdropdown-button-round-container').addClass('iqdropdown-multiple-container');
      }

      if (totalItems == 0) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.iqdropdown-button-round-container button-round:first-child').remove();
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.iqdropdown-button-round-container').removeClass('iqdropdown-multiple-container');
        counter = 0;
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('button-round.iqdropdown-clean').click(function () {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.iqdropdown-item-controls').each(function () {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.button-round-decrement').click();
        });
      }); //inactive buttons activations

      jquery__WEBPACK_IMPORTED_MODULE_1___default()('[data-id]').each(function () {
        if (count != 0) {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('[data-id=' + id + ']').find('.button-round-decrement').removeClass('iqdropdown-button_inactive');
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('[data-id=' + id + ']').find('.button-round-decrement').addClass('iqdropdown-button_inactive');
        }
      }); //onchange ending
    }
  }); //iqdropdown ending

  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.button-round-decrement').addClass('iqdropdown-button_inactive');
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.iqdropdown-selection').html('Сколько гостей');
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.iqdropdown-button-round-container').click(function (event) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.iqdropdown-button-round-container button-round:last-child').click(function () {
...
var Slider = /*#__PURE__*/_createClass(function Slider(el, options) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).ionRangeSlider(options);
});

var start, end;

function writeVal() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().parent().find('.slider__range').find('i').eq(0).text(start + '₽');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().parent().find('.slider__range').find('i').eq(1).text(' - ');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().parent().find('.slider__range').find('i').eq(2).text(end + '₽');
}
...
var _iterator = _createForOfIteratorHelper(jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-range-slider')),
    _step;

try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var el = _step.value;
    new Slider(jquery__WEBPACK_IMPORTED_MODULE_0___default()(el), options);
  }
} catch (err) {
  _iterator.e(err);
} finally {
...
jquery__WEBPACK_IMPORTED_MODULE_9___default()('.text-field').eq(1).find('input').addClass('text-field__field_hover');
var arr = [];
arr.push(jquery__WEBPACK_IMPORTED_MODULE_9___default()('.box-and-label__label:not(:first)'));
...
jquery__WEBPACK_IMPORTED_MODULE_9___default()('.toggle__item:first').find('input').trigger('click');

for (var i = 1; i < 3; i++) {
  jquery__WEBPACK_IMPORTED_MODULE_9___default()('.like-button').eq(0).trigger('click');
}

for (var _i2 = 1; _i2 < 13; _i2++) {
  jquery__WEBPACK_IMPORTED_MODULE_9___default()('.like-button').eq(1).trigger('click');
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_css-loader_dist_runtime_api_js-node_modules_css-loader_dist_runtime_getU-978f76","vendors-node_modules_air-datepicker_index_es_js-node_modules_inputmask_lib_extensions_inputma-a7fef4"], function() { return __webpack_require__("./src/pages/form-elements/form-elements.js"); })
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=form-elements,6accf1a158275f1daa92.js.map