# Задание от компании MetaLamp по разработке фронт-енд части веб-сайта отеля.
Данный проект представляет из себя веб-сайт отеля.<br/>
Представлены страницы (UI-kit) и непосредственно макет сайта.<br/>
Проект В РАЗРАБОТКЕ
